...
-- COVID EFFECT FOR COMPARISON (for reference)
SELECT *
FROM CovidEffects;
...
-- HIGHEST DEATH PERCENTAGE PER CASES IN THE WORLD & ASIA
--ASIA
...
SELECT location, date, 100*total_cases/population Cases_Rates, 100*CONVERT(bigint, total_vaccinations)/population Vaccination_Rates,
