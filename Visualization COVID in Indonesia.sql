...
SELECT location, date, population, total_cases, total_deaths, (CAST(total_deaths AS int)/population)*100 Death_Percentage
FROM CovidDeaths
ORDER BY location, date;
...
AND a.date = b.date
AND a.location IN ('Myanmar', 'Cambodia', 'Timor-Leste', 'Indonesia', 'Laos', 'Malaysia', 'Philippines',
